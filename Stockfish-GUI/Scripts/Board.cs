...
namespace Stockfish_GUI
{
    public class Board
    {
        ...
        public const string kFen = "rnba1abnr/4k4/1c5c1/p1p1p1p1p/9/9/P1P1P1P1P/1C5C1/4K4/RNBA1ANBR w - - 0 1";
        ...
        public void Redo(bool animate = true)
        {
            ...
            Move(Movements[MovementFocus], animate);
        }
        ...
        public void Undo(bool animate = true)
        {
            ...
            Undo(Movements[MovementFocus - 1], animate);
        }
        public void Switch()
        {
            Turn = !Turn;
